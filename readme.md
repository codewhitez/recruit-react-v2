...
This is a clone repository to create a one page application following the LO-FIs given in this assignment.
To start from the provided the base code.
...
The application contain one page and one test suite with four unit tests.
...
-   Please reach out to me at kyithar@outlook.com
